...
srun python scripts/02_train.py \
                ...
                --deterministic 'True' \
                --ckpt_path "outputs/finbenthic1/finbenthic1-2-base-200_efficientnet_b0/f0/finbenthic1-2-base-200_efficientnet_b0_f0_230907-1130-f987_epoch157_val-loss0.18.ckpt" \
                --resume 'False'